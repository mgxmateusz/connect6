...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("tactical_bot_v4_actions", &tactical_bot_v4_actions, "Connect6 GPU Tactical Bot V4 top12/top4 reply-pair6 actions");
    m.def("tactical_bot_full_pair_actions", &tactical_bot_full_pair_actions,
          "Connect6 GPU Tactical Bot exhaustive full-pair benchmark actions");
}

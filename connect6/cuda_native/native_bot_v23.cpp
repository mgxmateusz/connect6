...
extern "C" cudaError_t launch_tactical_bot_full_pair_cuda(
    const int8_t*, const int8_t*, const int8_t*, int16_t*, int64_t*, int, cudaStream_t);
extern "C" cudaError_t launch_tactical_bot_full_pair_pro_cuda(
    const int8_t*, const int8_t*, const int8_t*, int16_t*, int64_t*, int, cudaStream_t);
extern "C" cudaError_t launch_tactical_bot_pairfirst_p128_cuda(
    const int8_t*, const int8_t*, const int8_t*, int16_t*, int64_t*, int, cudaStream_t);
extern "C" cudaError_t launch_tactical_bot_pairfirst_p32_cuda(
    const int8_t*, const int8_t*, const int8_t*, int16_t*, int64_t*, int, cudaStream_t);
extern "C" cudaError_t launch_tactical_bot_pairfirst_pro_p128_cuda(
    const int8_t*, const int8_t*, const int8_t*, int16_t*, int64_t*, int, cudaStream_t);
extern "C" cudaError_t launch_tactical_bot_pairfirst_pro_p32_cuda(
    const int8_t*, const int8_t*, const int8_t*, int16_t*, int64_t*, int, cudaStream_t);
...
extern "C" cudaError_t launch_tactical_bot_hybrid_liveroad_pair128_cuda(
    const int8_t*, const int8_t*, const int8_t*, int16_t*, int64_t*, int, cudaStream_t);
extern "C" cudaError_t launch_tactical_bot_hybrid_liveroad_pair96_cuda(
    const int8_t*, const int8_t*, const int8_t*, int16_t*, int64_t*, int, cudaStream_t);
extern "C" cudaError_t launch_tactical_bot_hybrid_liveroad_pair64_cuda(
    const int8_t*, const int8_t*, const int8_t*, int16_t*, int64_t*, int, cudaStream_t);
...
SEARCH_BOT_WRAPPER(tactical_bot_v3_actions, launch_tactical_bot_v3_top16_cuda,
...
SEARCH_BOT_WRAPPER(tactical_bot_small_actions, launch_tactical_bot_small_top12_cuda,
                   "GPU Tactical Bot Small Top12 Pair-State")
SEARCH_BOT_WRAPPER(tactical_bot_v4_actions, launch_tactical_bot_v4_top12_replypair6_cuda,
...
SEARCH_BOT_WRAPPER(tactical_bot_full_pair_pro_actions, launch_tactical_bot_full_pair_pro_cuda,
                   "GPU Tactical Bot Full Pair Pro Brute Force")
...
SEARCH_BOT_WRAPPER(tactical_bot_pairfirst_pro_actions, launch_tactical_bot_pairfirst_pro_p128_cuda,
                   "GPU Tactical Bot PairFirst Pro AllPairs P128")
SEARCH_BOT_WRAPPER(tactical_bot_pairfirst32_pro_actions, launch_tactical_bot_pairfirst_pro_p32_cuda,
                   "GPU Tactical Bot PairFirst Pro AllPairs P32")
SEARCH_BOT_WRAPPER(tactical_bot_liveroad_actions, launch_tactical_bot_liveroad_cuda,
                   "GPU Tactical Bot LiveRoad Brute Force")
SEARCH_BOT_WRAPPER(tactical_bot_liveroad_pro_actions, launch_tactical_bot_liveroad_pro_cuda,
                   "GPU Tactical Bot LiveRoad Pro Brute Force")
...
SEARCH_BOT_WRAPPER(tactical_bot_hybrid96_actions, launch_tactical_bot_hybrid_liveroad_pair96_cuda,
                   "GPU Tactical Bot Hybrid LiveRoad Pair96")
SEARCH_BOT_WRAPPER(tactical_bot_hybrid64_actions, launch_tactical_bot_hybrid_liveroad_pair64_cuda,
...
SEARCH_BOT_WRAPPER(tactical_bot_hybrid_pro_actions, launch_tactical_bot_hybrid_pro_pair128_cuda,
                   "GPU Tactical Bot Hybrid Pro LiveRoad Pair128")
SEARCH_BOT_WRAPPER(tactical_bot_hybrid32_pro_actions, launch_tactical_bot_hybrid_pro_pair32_cuda,
                   "GPU Tactical Bot Hybrid Pro LiveRoad Pair32")
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("tactical_bot_v3_pro_actions", &tactical_bot_v3_pro_actions, "Connect6 GPU Tactical Bot V3 Pro top16 actions");
    ...
    m.def("tactical_bot_v4_pro_actions", &tactical_bot_v4_pro_actions, "Connect6 GPU Tactical Bot V4 Pro reply-pair6 actions");
    ...
    m.def("tactical_bot_full_pair_pro_actions", &tactical_bot_full_pair_pro_actions,
          "Connect6 GPU Tactical Bot exhaustive full-pair actions with V2Pro tie prior");
    ...
    m.def("tactical_bot_pairfirst_pro_actions", &tactical_bot_pairfirst_pro_actions,
          "Connect6 GPU Tactical Bot PairFirst TOP128 with V2Pro endpoint prior");
    m.def("tactical_bot_pairfirst32_pro_actions", &tactical_bot_pairfirst32_pro_actions,
          "Connect6 GPU Tactical Bot PairFirst TOP32 with V2Pro endpoint prior");
    ...
    m.def("tactical_bot_liveroad_pro_actions", &tactical_bot_liveroad_pro_actions,
          "Connect6 GPU Tactical Bot LiveRoad with V2Pro seed/tie ordering");
    ...
    m.def("tactical_bot_hybrid96_actions", &tactical_bot_hybrid96_actions,
          "Connect6 GPU Tactical Bot pure LiveRoad pool then cheap TOP96 exact actions");
    m.def("tactical_bot_hybrid64_actions", &tactical_bot_hybrid64_actions,
          "Connect6 GPU Tactical Bot pure LiveRoad pool then cheap TOP64 exact actions");
    ...
    m.def("tactical_bot_hybrid_pro_actions", &tactical_bot_hybrid_pro_actions,
          "Connect6 GPU Tactical Bot Hybrid TOP128 with V2Pro endpoint prior");
    m.def("tactical_bot_hybrid32_pro_actions", &tactical_bot_hybrid32_pro_actions,
          "Connect6 GPU Tactical Bot Hybrid TOP32 with V2Pro endpoint prior");
}

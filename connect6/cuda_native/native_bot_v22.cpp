...
torch::Tensor tactical_bot_v2_pro_actions(torch::Tensor b, torch::Tensor p, torch::Tensor l) {
    return tactical_bot_actions_impl(b, p, l, launch_tactical_bot_v2_pro_cuda,
                                     "GPU Tactical Bot V2 Pro LatentFork");
}
torch::Tensor tactical_bot_v2_pro2_actions(torch::Tensor b, torch::Tensor p, torch::Tensor l) {
    return tactical_bot_actions_impl(b, p, l, launch_tactical_bot_v2_pro2_cuda,
                                     "GPU Tactical Bot V2 Pro2 PairForce");
}
...
torch::Tensor tactical_bot_pairfirst32_actions(torch::Tensor b, torch::Tensor p, torch::Tensor l, torch::Tensor pending) {
    return tactical_search_actions_impl(b, p, l, pending, launch_tactical_bot_pairfirst_p32_cuda,
...
torch::Tensor tactical_bot_hybrid96_actions(torch::Tensor b, torch::Tensor p, torch::Tensor l, torch::Tensor pending) {
    return tactical_search_actions_impl(b, p, l, pending, launch_tactical_bot_hybrid_liveroad_pair96_cuda,
                                        "GPU Tactical Bot Hybrid LiveRoad Pair96");
}
torch::Tensor tactical_bot_hybrid64_actions(torch::Tensor b, torch::Tensor p, torch::Tensor l, torch::Tensor pending) {
    return tactical_search_actions_impl(b, p, l, pending, launch_tactical_bot_hybrid_liveroad_pair64_cuda,
                                        "GPU Tactical Bot Hybrid LiveRoad Pair64");
}
torch::Tensor tactical_bot_hybrid32_actions(torch::Tensor b, torch::Tensor p, torch::Tensor l, torch::Tensor pending) {
    return tactical_search_actions_impl(b, p, l, pending, launch_tactical_bot_hybrid_liveroad_pair32_cuda,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("tactical_bot_v2_pro2_actions", &tactical_bot_v2_pro2_actions,
          "Connect6 GPU Tactical Bot V2 Pro2 local partner pair-force-aware one-cell actions");
